...
loadTextures({
    "layer1": "tmhp:dc/batfamily/nightwing/new52/layer1",
    "layer2": "tmhp:dc/batfamily/nightwing/new52/layer2",
    "electric_glow": "tmhp:dc/batfamily/nightwing/new52/electric_glow",
...
function initEffects(renderer) {
    ...
    utils.bindTrail(renderer, "tmhp:electrical_suit_red").setCondition(entity => entity.getData("tmhp:dyn/electrical_timer") > 0);
