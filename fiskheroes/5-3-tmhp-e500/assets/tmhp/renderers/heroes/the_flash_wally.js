...
loadTextures({
    "layer1": "tmhp:dc/flashfamily/wally/rebirth/layer1",
    "layer2": "tmhp:dc/flashfamily/wally/rebirth/layer2",
    "mask": "tmhp:dc/flashfamily/wally/rebirth/mask.tx.json",
    "lights": "tmhp:dc/flashfamily/wally/rebirth/lights",

    "manhattan": "tmhp:dc/flashfamily/wally/rebirth/manhattan",
    "manhattan_lights": "tmhp:dc/flashfamily/wally/rebirth/manhattan_lights",
    "manhattan_mask": "tmhp:dc/flashfamily/wally/rebirth/manhattan_mask.tx.json",

    "flash": "tmhp:dc/flashfamily/wally/rebirth/flash",
    "flash_lights": "tmhp:dc/flashfamily/wally/rebirth/flash_lights",
    "flash_mask": "tmhp:dc/flashfamily/wally/rebirth/flash_mask.tx.json"
});
...
function init(renderer) {
    ...
    manhattan_mask.texture.set("manhattan_mask");
    ...
    flash_mask.texture.set("flash_mask");
...
function initEffects(renderer) {
    ...
    utils.bindTrail(renderer, "tmhp:manhattan").setCondition(entity => entity.getData("fiskheroes:speeding") && entity.getData('fiskheroes:speed') > 5 && entity.getData('fiskheroes:speed') <= 10);
    ...
    utils.bindBeam(renderer, "fiskheroes:energy_manipulation", "fiskheroes:energy_discharge", "rightArm", 0x8888FF, [
        { "firstPerson": [-2.5, 0.0, -7.0], "offset": [-0.5, 19.0, -12.0], "size": [1.5, 1.5] }
    ]).setCondition(entity => entity.getData('fiskheroes:speed') <= 5);

    utils.bindBeam(renderer, "fiskheroes:energy_manipulation", "fiskheroes:energy_discharge", "rightArm", 0x1111FF, [
        { "firstPerson": [-2.5, 0.0, -7.0], "offset": [-0.5, 19.0, -12.0], "size": [1.5, 1.5] }
