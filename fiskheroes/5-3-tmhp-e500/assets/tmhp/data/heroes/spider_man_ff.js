function init(hero) {
    hero.setName("Spider-Man/\u00A7c\u00A7lAP 5");
    hero.setVersion("Future Foundation");
    hero.setTier(7);
    ...
    hero.addPowers("fiskheroes:spider_physiology", "fiskheroes:web_shooters_ps4", "tmhp:stealth_suit");
    ...
    hero.addKeyBind("STEALTH_MOD", "Stealth Mod", 5);
