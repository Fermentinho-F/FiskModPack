...
function init(hero) {
    ...
    hero.addKeyBind("ARTIC_STEALTH_MOD", "Artic Stealth Mod", 4);
...
function isKeyBindEnabled(entity, keyBind) {
    switch (keyBind) {
    case "CHARGE_ENERGY":
        return entity.getHeldItem().isEmpty() && entity.getData("fiskheroes:speeding");
    case "STEALTH_MOD":
        return !entity.getData("tmhp:dyn/artic_stealth");
    case "ARTIC_STEALTH_MOD":
        return !entity.getData("tmhp:dyn/stealth");
    default:
        return true;
    }
}
