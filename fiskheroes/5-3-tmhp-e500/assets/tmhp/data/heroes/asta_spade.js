...
function init(hero) {
    ...
    hero.addPowers("tmhp:anti_mahou", "tmhp:devil_union");
    ...
    hero.addKeyBind("CHARGE_ENERGY", "Black Slash", 1);
    hero.addKeyBind("CHARGED_BEAM", "Infinity Slash:Equinox", 1);
    ...
    hero.addKeyBind("BLACKFORM2", "Toggle Black Form", 4);
    hero.addKeyBind("DEVILUNION", "Toggle Devil Union", 4);
...
function blacksamuraiProfile(profile) {
    profile.inheritDefaults();
    profile.addAttribute("SPRINT_SPEED", 1.4, 1);
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    case "CHARGED_BEAM":
        return entity.getHeldItem().name() == "fiskheroes:katana" && entity.getData("tmhp:dyn/devil_union");
    case "BLADE":
    ...
    case "BLACKFORM2":
        return entity.isSneaking() && !entity.getData("tmhp:dyn/devil_union_cooldown") && (entity.getData("fiskheroes:shield") || entity.getData("fiskheroes:blade") || entity.getHeldItem().name() == "fiskheroes:katana") || entity.getData("tmhp:dyn/blackform2");
    case "DEVILUNION":
        return !entity.isSneaking() && !entity.getData("tmhp:dyn/blackform2_cooldown") && (entity.getData("fiskheroes:shield") || entity.getData("fiskheroes:blade") || entity.getHeldItem().name() == "fiskheroes:katana") || entity.getData("tmhp:dyn/devil_union");
    default:
        return true;
    }
}
