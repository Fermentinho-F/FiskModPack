function init(hero) {
    hero.setName("Anakin Skywalker");
    hero.setAliases("Chosen_One", "Sky_Guy");
    hero.setTier(7);
    ...
    hero.addPowers("swhp:lightsaber_anakin", "swhp:jedi_force", "swhp:chosenone", "swhp:formv_djemso");
    ...
    hero.addKeyBind("VSPECIAL", "Heroic Might", 5);
    ...
    hero.addSoundEvent("MASK_OPEN", "swhp:voicelines_anakin");
