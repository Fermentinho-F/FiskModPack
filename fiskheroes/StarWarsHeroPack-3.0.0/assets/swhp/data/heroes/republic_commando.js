function init(hero) {
    hero.setName("Republic Commando");
    hero.setAliases("Clone_Commando");
    hero.setTier(6);
    ...
    hero.addPrimaryEquipment('fisktag:weapon{WeaponType:"swhp:dc17m", display:{Lore:["\u00A76\u00A7lStar Wars\u00A7r"]}}', true, item => item.nbt().getString("WeaponType") == "swhp:dc17m");
    
    hero.addPowers("swhp:republic_commando_armor");
