function init(hero) {
    hero.setName("Darth Revan");
    hero.setAliases("The_Butcher");
    hero.setVersion("\u00A7c\u00A7lSWTOR\u00A7r");
    hero.setTier(8);
    ...
    hero.addPowers("swhp:lightsaber_darthrevan", "swhp:sith_force", "swhp:lightningstorm", "swhp:formiv");
    ...
    hero.addKeyBind("FORCELIGHTNING", "Force Lightning", 5);
    hero.addKeyBind("VSPECIAL", "Lightning Storm", 5);
...
function sithabilityCycle(player, manager) {
  ...
  if (player.getData("swhp:dyn/sith_ability_cycle") > 4) {
...
function getAttributeProfile(entity) {
    if (entity.getData("fiskheroes:beam_charging") && (entity.getData("swhp:dyn/sith_ability_cycle") == 3)) {
        return "SITHABILITY";
    }
...
function isModifierEnabled(entity, modifier) {
    ...
    case "fiskheroes:charged_beam":
      switch (modifier.id()) {
        ...
        case "forcelightning":
          return entity.getData("swhp:dyn/sith_ability_cycle") == 2;
        case "fury":
          return entity.getData("swhp:dyn/sith_ability_cycle") == 3;
        case "lightsaberthrow":
          return entity.getData("swhp:dyn/lightsaberignite") && entity.getData("swhp:dyn/sith_ability_cycle") == 4;
      };
    default:
        return true;
    }
...
function isKeyBindEnabled(entity, keyBind) {
    switch (keyBind) {
        ...
        case "LIGHTSABERTHROWANIMATION":
            return entity.getData("swhp:dyn/lightsaberignite") && entity.getData("swhp:dyn/sith_ability_cycle") == 4 && entity.getData("fiskheroes:beam_charging");
        default:
            return true;
    }
}