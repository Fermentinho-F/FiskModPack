function init(hero) {
    ...
    hero.addPowers("swhp:lightsaber_kenobi", "swhp:jedi_force", "swhp:jedimindtrick", "swhp:formiii");
    ...
    hero.addAttribute("FALL_RESISTANCE", 60.0, 0);
    ...
    hero.addKeyBind("VSPECIAL", "Jedi Mind Trick", 5);
    ...
    hero.addSoundEvent("MASK_OPEN", "swhp:voicelines_kenobi");
    hero.addSoundEvent("PUNCH", "swhp:lightsaber_swing_kenobi");
}
