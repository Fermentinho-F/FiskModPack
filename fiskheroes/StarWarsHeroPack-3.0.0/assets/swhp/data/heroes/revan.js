function init(hero) {
    hero.setName("Jedi Knight Revan");
    hero.setAliases("Redeemed");
    hero.setVersion("\u00A7c\u00A7lKOTOR\u00A7r");
    hero.setTier(7);
    ...
    hero.addPowers("swhp:lightsaber_revan", "swhp:grey_force", "swhp:fury", "swhp:formv_shien");
    ...
    hero.addKeyBind("VSPECIAL", "Unleash Fury", 5);
