function init(hero) {
    hero.setName("Captain Rex");
    hero.setAliases("CT_7567", "Rex", "ARC_Troopers");
    hero.setTier(7);
    ...
    hero.setBoots("Boots");
    hero.addPrimaryEquipment('fisktag:weapon{WeaponType:"swhp:dc17_dual", display:{Lore:["\u00A76\u00A7lStar Wars\u00A7r"]}}', true, item => item.nbt().getString("WeaponType") == "swhp:dc17_dual");
    ...
    hero.addPowers("swhp:clone_trooper_captain_armor");
