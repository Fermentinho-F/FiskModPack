...
loadTextures({
    "layer1": "moopack:ultra_illumination/ultra_illumination_layer1",
    "layer2": "moopack:ultra_illumination/ultra_illumination_layer2",
    "layer1_lights": "moopack:ultra_illumination/illumination_lights",
    "layer2_lights": "moopack:ultra_illumination/illumination_lights2",
    "cape": "moopack:ultra_illumination/illumination_cape"
});
...
function initEffects(renderer) {
    ...
    utils.bindCloud(renderer, "fiskheroes:teleportation", "moopack:light_breach");
   ...
   utils.bindBeam(renderer, "fiskheroes:energy_projection", beam, "body", 0xFFFF00, [
