...
loadTextures({
    ...
    "wings": "moopack:dna/nature_wings",
    "jetpack": "moopack:dna/nature_jetpack",
    "jetpack_lights": "moopack:dna/nature_jetpack_lights"
});
...
function initBoosters(renderer, utils, falcon_boosters) {
    ...
    return falcon_boosters.create(renderer, 0x65fe08, "moopack:invis_flight_layer_%s", {
        boosters: [
