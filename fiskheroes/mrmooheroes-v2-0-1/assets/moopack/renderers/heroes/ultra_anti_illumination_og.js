...
loadTextures({
    ...
    "cape": "moopack:ultra_anti_illumination/anti_illumination_cape",
    "segment": "moopack:ultra_anti_illumination/tentacle_dark_wide_2",
    "claw": "moopack:ultra_anti_illumination/claw_dark_4x4"
});
...
function initEffects(renderer) {
    ...
    var arm = utils.createModel(renderer, "moopack:tentacle_symbiot_venom", "segment");
    var claw = utils.createModel(renderer, "moopack:claw_venom_4x4", "claw");
    claw.bindAnimation("moopack:symbiot_4x4_claw").setData((entity, data) => {
