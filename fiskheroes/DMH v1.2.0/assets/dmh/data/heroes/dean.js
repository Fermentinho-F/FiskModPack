function init(hero) {
    hero.setName("Dean Winchester/Knight Of Hell & Hunter");
    hero.setTier(9);
    ...
    hero.addPrimaryEquipment("fisktag:weapon{WeaponType:dmh:first_blade}", true, item => item.nbt().getString("WeaponType") == "dmh:first_blade");
    ...
    hero.addPowers("dmh:knight_of_hell", "dmh:mark_of_cain", "dmh:hunting", "dmh:first_blade");

    hero.addAttribute("PUNCH_DAMAGE", 10.0, 0);
    hero.addAttribute("SPRINT_SPEED", 0.15, 1);
    hero.addAttribute("KNOCKBACK", 0.10, 1);
    hero.addAttribute("FALL_RESISTANCE", 0.20, 1);
    hero.addAttribute("WEAPON_DAMAGE", 0.20, 1);
...
function hasPermission(entity, permission) {
    return permission == "USE_GUN" || "MARK_OF_CAIN" || "ANGEL_BLADE";
}
