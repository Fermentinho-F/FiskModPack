...
loadTextures({
    "layer1": "dmh:sn/castiel/castiel_l1",
    "layer2": "dmh:sn/castiel/castiel_l2",
...
function initEffects(renderer) {
    ...
    renderer.bindProperty("fiskheroes:opacity").setOpacity((entity, renderLayer) => {
        return 1 - 0.99999 * entity.getInterpolatedData("fiskheroes:dyn/nanite_timer");
    });
...
function initAnimations(renderer) {
    ...
    addAnimationWithData(renderer, "castiel.AIMING", "fiskheroes:aiming", "dmh:dyn/transform_timer").priority = 10;

    addAnimation(renderer, "castiel.CHARGED_BEAM", "fiskheroes:aiming").setData((entity, data) => {
    ...
    addAnimation(renderer, "castiel.ENERGY_PROJ", "fiskheroes:aiming").setData((entity, data) => {
    ...
    /** addAnimation(renderer, "castiel.CHARGED_BEAM", "dmh:aiming", "dmh:dyn/transform_timer").priority = 10;
    addAnimation(renderer, "castiel.ENERGY_PROJECTION", "dmh:aiming", "dmh:dyn/transform_timer").priority = 10; **/


    utils.addFlightAnimation(renderer, "castiel.FLIGHT", "fiskheroes:flight/default.anim.json");
    utils.addHoverAnimation(renderer, "castiel.HOVER", "fiskheroes:flight/idle/neutral");

    addAnimationWithData(renderer, "castiel.LAND", "fiskheroes:superhero_landing", "fiskheroes:dyn/superhero_landing_timer")
        .priority = -8;
}
