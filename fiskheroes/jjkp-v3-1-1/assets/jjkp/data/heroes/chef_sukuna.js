...
function init(hero) {
    hero.setName("Sukuna");
    hero.setVersion("Chef");
    hero.setTier(8);

    hero.setHelmet("Chef Hat");
    hero.setChestplate("Apron");
    hero.setLeggings("Pants");
    hero.setBoots("Shoes");

    hero.addPowers("jjkp:malevolent_kitchen", "jjkp:king_curse_physiology", "jjkp:cooking_cleave", "jjkp:cursed_energy", "jjkp:reverse_cursed_technique");
    ...
    hero.addKeyBind("CHARGED_BEAM", "Cooking Cleave", 2);
    ...
    hero.addKeyBind("KITCHEN", "Malevolent Kitchen", 5);
...
function shrineProfile(profile) {
    ...
    profile.addAttribute("FALL_RESISTANCE", 0.5, 1);
}
