...
loadTextures({
    "layer1": "jjkp:chef_sukuna/chef_sukuna_layer1",
    "layer2": "jjkp:chef_sukuna/chef_sukuna_layer2",
    "domain_floor": "jjkp:sukuna/domain_floor",
    "arms": "jjkp:chef_sukuna/chef_sukuna_layer1",
    "slash": "jjkp:sukuna/slash",
    "domain_shrine": "jjkp:chef_sukuna/sukuna_kitchen",
    "hat": "jjkp:chef_sukuna/chef_hat"
});
...
function initEffects(renderer) {
    ...
    var model = renderer.createResource("MODEL", "jjkp:sukuna_kitchen");
    model.texture.set("domain_shrine");
    domainshrine = renderer.createEffect("fiskheroes:model").setModel(model);
    domainshrine.setOffset(0, -15, 0)
    domainshrine.setScale(2.0);
    ...
    var model = renderer.createResource("MODEL", "jjkp:chef_hat");
    model.texture.set("hat");
    hat = renderer.createEffect("fiskheroes:model").setModel(model);
    hat.setOffset(0, 0, 0)
    hat.setScale(1.0);
    hat.anchor.set("head");
