...
loadTextures({
    ...
    "sukunalines": "jjkp:itadori_sukuna/itadori_sukuna_lines",
    "domain_floor": "jjkp:sukuna/domain_floor",
    "arms": "jjkp:itadori/itadori_layer1",
...
function initEffects(renderer) {
    ...
    overlay.texture.set("sukunalines");
...
function render(entity, renderLayer, isFirstPersonArm) {
    if (renderLayer == "HELMET" || renderLayer == "CHESTPLATE" || renderLayer == "LEGGINGS" || renderLayer == "BOOTS") {
        overlay.opacity = entity.getInterpolatedData("jjkp:dyn/sukuna_timer");
        overlay.render();
    }
