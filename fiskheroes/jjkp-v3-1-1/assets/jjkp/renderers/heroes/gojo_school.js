...
loadTextures({
    "layer1": "jjkp:gojo/gojo_school_layer1",
    "layer2": "jjkp:gojo/gojo_school_layer2",
    "noblindfold": "jjkp:gojo/gojo_school_noglasses_layer1",
    "infinitevoid": "jjkp:gojo/infinite_void",
    "glasses": "jjkp:gojo/gojo_glasses"
});
...
function initEffects(renderer) {
    ...
    var model = renderer.createResource("MODEL", "jjkp:gojo_glasses");
    model.texture.set("glasses");
    glasses = renderer.createEffect("fiskheroes:model").setModel(model);
    glasses.setOffset(0, 0, 0)
    glasses.setScale(1.0);
...
function initAnimations(renderer) {
    ...
    addAnimation(renderer, "flash.MASK", "jjkp:remove_glasses")
    .setData((entity, data) => {
...
function render(entity, renderLayer, isFirstPersonArm) {
    ...
    if (renderLayer == "HELMET" && !isFirstPersonArm && !entity.getData("fiskheroes:mask_open")) {
        glasses.render();
    }
}
