...
loadTextures({
    "layer1": "jmctheroes:war/mk2/war_machine_mk2_layer1",
    "layer2": "jmctheroes:war/mk2/war_machine_mk2_layer2",
    "lights": "jmctheroes:war/mk2/war_machine_mk2_lights_layer1",
    "suit": "jmctheroes:war/mk2/war_machine_mk2_suit.tx.json",
    "mask": "jmctheroes:war/mk2/war_machine_mk2_mask.tx.json",
    "chin": "jmctheroes:war/mk2/war_machine_mk2_chin.tx.json",
    "backpack": "jmctheroes:war/mk2/war_machine_mk2_backpack",
    //"backpack": "jmctheroes:war/mk2/war_machine_mk2_backpack.tx.json",
...
function initEffects(renderer) {
    ...
    var model = renderer.createResource("MODEL", "jmctheroes:warbackpackmk2");
    model.bindAnimation("jmctheroes:warmachine_mk2").setData((entity, data) => {
        data.load(0, Math.max(entity.getData("fiskheroes:flight_boost_timer")));
        data.load(1, Math.max(entity.getInterpolatedData("fiskheroes:beam_charge") || entity.getInterpolatedData("jmctheroes:dyn/suit_open")));
    });
    ...
    lowbarrelRight.setIcon(fire).setOffset(0.8, -5.5, 0.0).setRotation(-180, 0, 0).setSize(1.5, 3.0);
    lowbarrelRight.anchor.set("body", model.getCubeOffset("guntop"));

    lowbarrelLeft = renderer.createEffect("fiskheroes:booster")
    lowbarrelLeft.setIcon(fire).setOffset(-0.8, -5.5, 0.0).setRotation(-180, 0, 0).setSize(1.5, 3.0);
    lowbarrelLeft.anchor.set("body", model.getCubeOffset("guntop"));
