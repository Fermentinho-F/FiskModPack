...
function init(hero) {
    hero.setName("Ultimate Spider-Man/Miles Morales");
    hero.setAliases("miles", "morales");
    hero.setTier(7);
    ...
    hero.addPowers("fiskheroes:spider_physiology", "jmctheroes:upgraded_web_shooters", "jmctheroes:bio_elctricity", "jmctheroes:spider_camouflage");
    ...
    hero.addKeyBind("CHARGE_ENERGY", "Venom Blast", 5);
    hero.addKeyBind("INVIS", "Invisibility", 5);
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    case "CHARGE_ENERGY":
        return !entity.isSneaking() && entity.getHeldItem().isEmpty();
    default:
        return true;
    }
}
