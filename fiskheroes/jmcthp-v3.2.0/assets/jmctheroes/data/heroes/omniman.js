...
function init(hero) {
    hero.setName("Omni-Man/Nolan Grayson");
    hero.setVersion("Invincible");
    hero.setAliases("nolan");
    hero.setTier(9);
    ...
    hero.addPowers("jmctheroes:viltrumite_physiology_omniman");
    hero.addAttribute("PUNCH_DAMAGE", 13, 0);
    hero.addAttribute("SPRINT_SPEED", 0.45, 1);
    hero.addAttribute("JUMP_HEIGHT", 1.5, 0);
    hero.addAttribute("FALL_RESISTANCE", 1.0, 1);
    hero.addAttribute("WEAPON_DAMAGE", -0.5, 1);
    hero.addAttribute("IMPACT_DAMAGE", 0.2, 1);
