function init(hero) {
    ...
    hero.addPowers("jmctheroes:pork_grind_physiology", "jmctheroes:upgraded_web_shooters1");
    hero.addAttribute("FALL_RESISTANCE", 12.0, 0);
    hero.addAttribute("JUMP_HEIGHT", 2.5, 0);
    hero.addAttribute("PUNCH_DAMAGE", 8.7, 0);
    ...
    hero.addKeyBind("BLADE", "Ham Smasher", 5);
...
function bladeProfile(profile) {
    ...
    profile.addAttribute("PUNCH_DAMAGE", 9.4, 0);
}
