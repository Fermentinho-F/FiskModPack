function init(hero) {
    hero.setName("Sinestro Lantern Corp");
    hero.setAliases("yellowring");
    hero.setTier(9);
    
    hero.setChestplate("Ring");

    hero.addPowers("jmctheroes:yellow_lantern_corp_ring");
    ...
    hero.addKeyBind("SPELL_MENU", "key.spellMenu", 1);
...
function isModifierEnabled(entity, modifier) {
    ...
    case "fiskheroes:repulsor_blast":
        return entity.getData("jmctheroes:dyn/suit") && !entity.getData("fiskheroes:flight_boost_timer") == 1 && entity.getData("fiskheroes:flying");  
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    switch (keyBind) {
    case "AIM":
        return entity.getHeldItem().isEmpty() && entity.getData("jmctheroes:dyn/suit_timer") == 1 && entity.getData("fiskheroes:flying") && !entity.getData("fiskheroes:flight_boost_timer") == 1  && !entity.getData("fiskheroes:shield") && !entity.getData("fiskheroes:blade");
    case "TELEKINESIS":
...
function canAim(entity) {
    return entity.getHeldItem().isEmpty() && entity.getData("jmctheroes:dyn/suit") && entity.getData("fiskheroes:flying");
}