...
function init(hero) {
    hero.setName("War Machine/Mark 2");
    hero.setAliases("warmk2", "wmmk2");
    hero.setTier(7);
    ...
    hero.addPowers("jmctheroes:war_machine_armor_mk2");
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    switch (keyBind) {
        ...
        case "CHARGED_BEAM":
            return entity.getHeldItem().isEmpty() && !entity.getData("fiskheroes:flying") && !entity.getData("fiskheroes:aiming");
        case "HEAT_VISION":
