function init(hero) {
    hero.setName("Red Light Saber");
    hero.setTier(1);
    
    hero.setChestplate("And Dark Force Power");
    
    hero.addPowers("emo:sith");
    ...
    hero.addKeyBind("TELEKINESIS", "Dark Force Telekinesis", 3);
    hero.addKeyBind("ENERGY_PROJECTION", "Dark Force Telekinesis", 3);
    hero.addKeyBind("AIM", "Dark Force Telekinesis", 3);
