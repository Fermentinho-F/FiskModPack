...
function initEffects(renderer) {
    ...
    trail.setTrail(renderer.createResource("TRAIL", "emo:lightning_nz"));
    trail.setCondition(entity => entity.getData("fiskheroes:speeding") && entity.getData("fiskheroes:speed") <= 8);

    trail = renderer.bindProperty("fiskheroes:trail");
    trail.setTrail(renderer.createResource("TRAIL", "emo:lightning_green"));
    trail.setCondition(entity => entity.getData("fiskheroes:speeding") && entity.getData("fiskheroes:speed") > 8);
    ...
    utils.bindCloud(renderer, "fiskheroes:telekinesis", "emo:albedo");
