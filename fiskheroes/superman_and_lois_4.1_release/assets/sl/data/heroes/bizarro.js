...
function init(hero) {
    hero.setName("Bizarro/\u00A7c\u00A7lAP 8\u00A7r");
    hero.setTier(9);
    ...
    hero.addKeyBind("AIM", "Cold Vision", 1);
  ...
  hero.addKeyBind("100", "\u00A76\u00A7lEarth Smash - 100 Percent", 5);
    ...
    hero.addSoundEvent("MASK_OPEN", "sl:bizarrosound");
    hero.addSoundEvent("MASK_CLOSE", "sl:bizarrosound");
    hero.addSoundEvent("AIM_START", "sl:icevision_charge");

    hero.addSoundEvent("PUNCH", "sl:bizarrohit");
    hero.addSoundOverrides("nb", {
        "suit": {
            "PUNCH": "sl:inversepunch",
            "MASK_OPEN": "sl:bizarroglitch",
            "MASK_CLOSE": "sl:bizarroglitch"
        }
    });
    ...
    kutils.bizarroGlitch(entity, manager);
  ...
  if (entity.getData("sl:dyn/heat_breath")) {
    ...
    if (entity.getData("sl:dyn/oxygen") > 0.8) {
      ...
      return !entity.getData("sl:dyn/inverseabsorb") 
        ...
        case "HEAT_VISION":
            return !entity.getData("fiskheroes:beam_shooting") && entity.getData("fiskheroes:aiming_timer") == 1 && !entity.getData("sl:dyn/sboost") && !entity.getData("sl:dyn/sboost2");
	...
	case "GRAVITY_MANIPULATION":
        ...
        case "AIM":
            return !entity.getData("sl:dyn/sboost") && !entity.getData("sl:dyn/sboost2");
        case "0":
