...
if (entity.getData("sl:dyn/printchat") && PackLoader.getSide() == "CLIENT") {
    ...
    if (!b) {
        ...
        case "XKRYPTONITE":
          ...
          if (entity.getData("sl:dyn/heat_vision")) {
                if (entity.getData("sl:dyn/absorb") || entity.getData("fiskheroes:mask_open") || entity.getData("fiskheroes:energy_projection") || entity.getData("sl:dyn/sboost")) {
                    return true;
                } else {
                    if (entity.getData("fiskheroes:beam_charge") === 0) {
...
function changesuitKey(player, manager) {
    ...
    if (item3.nbt().getString('HeroType') === "sl:talrho") {
        ...
        manager.setString(item1.nbt(), "HeroType", "sl:talrho_supercharged");
        manager.setString(item2.nbt(), "HeroType", "sl:talrho_supercharged");
        manager.setString(item3.nbt(), "HeroType", "sl:talrho_supercharged");
