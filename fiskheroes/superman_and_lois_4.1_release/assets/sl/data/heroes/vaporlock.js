...
function init(hero) {
    hero.setName("Starlight/\u00A7c\u00A7lAP 6\u00A7r");
    hero.setTier(9);
    hero.hide();

    hero.setDefaultScale(0.98);
    ...
    hero.addAttribute("FALL_RESISTANCE", 0.96, 1);
...
if (entity.getData("sl:dyn/hammer_timer") === 1) {
    ...
    if (y > 2000 && dim == 0) { // teleport to moon from overworld
    ...
    } else if (y > 2000 && dim == 2595) { // teleport to overworld from moon
