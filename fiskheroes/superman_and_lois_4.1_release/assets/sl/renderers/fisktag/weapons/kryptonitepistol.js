loadTextures({
    "base":      "sl:kryptonite_pistol",
    "crosshair": "fisktag:crosshairs/pistol",
    "base_lights": "sl:kryptonitepistol_lights"
});
...
function init(renderer, modelType, texture, tex) {
    model = utils.createModel(renderer, "fisktag:pistol", "base", "base_lights");
    ...
    utils.bindScopedBeam(renderer, "fiskheroes:repulsor_blast", 0x4A8D4B, [
