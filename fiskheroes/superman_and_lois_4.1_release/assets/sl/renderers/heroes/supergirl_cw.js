...
loadTextures({
  "layer1": "sl:supergirl/supergirl_cw_layer1_hair",
  "layer2": "sl:supergirl/supergirl_cw_layer2",
  "eyes": "sl:superman_eyes",
  "cape": "sl:supergirl/supergirl_cape",
  "cape_hair": "sl:supergirl/supergirl_cape_hair",
  "lights": "sl:supercharged",
  "supercharging": "sl:sun",
  "null": "sl:null",
  "suittexture": "sl:superman_suit_texture",
  "chest": "sl:supergirl/supergirl_cw_layer1",
  "hair": "sl:supergirl/supergirl_cw_hair",
...
addAnimation(renderer, "superman.BREATH2", "sl:leaning")
    .setData((entity, data) => {
        data.load(1, entity.getInterpolatedData("sl:dyn/steelchargedata"));
    })
    .setCondition(entity => {
        return entity.getData("fiskheroes:energy_projection_timer") > 0 && !entity.isSneaking();
    })
    .priority = -10;
...
if (renderLayer === "CHESTPLATE") {
  ...
  if (entity.getEquipmentInSlot(4).nbt().getString('HeroType') === 'sl:supergirl_cw' || entity.getEquipmentInSlot(4).nbt().getString('HeroType') === 'sl:supergirl_cw/s1') {
    cape2.render(entity);
  } else {
    cape.render(entity);
  }
