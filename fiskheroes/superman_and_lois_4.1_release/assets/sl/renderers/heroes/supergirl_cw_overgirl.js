...
loadTextures({
  "layer1": "sl:supergirl/overgirl_layer1_hair",
  "layer2": "sl:supergirl/overgirl_layer2",
  "eyes": "sl:supergirl/overgirl_eyes",
  "cape": "sl:supergirl/overgirl_cape",
  "cape_hair": "sl:supergirl/overgirl_cape_hair",
  "lights": "sl:supercharged",
  "supercharging": "sl:sun",
  "null": "sl:null",
  "suittexture": "sl:superman_suit_texture",
  "chest": "sl:supergirl/overgirl_layer1",
  "hair": "sl:supergirl/overgirl_hair_mask",
...
//regular
  ...
  utils.bindTrail(renderer, "sl:overgirl_trail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup"));
...
if (renderLayer === "CHESTPLATE") {
  ...
  if (entity.getEquipmentInSlot(4).nbt().getString('HeroType') === 'sl:supergirl_cw/overgirl') {
    cape2.render(entity);
  } else {
    cape.render(entity);
  }
