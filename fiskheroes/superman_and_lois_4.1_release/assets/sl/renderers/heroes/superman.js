...
loadTextures({
  "layer1": "sl:superman_layer1",
  "layer2": "sl:superman_layer2",
  "eyes": "fiskheroes:reverse_flash_eyes",
  "cape": "sl:bizarro_cape",
  "cape_tired": "sl:normalbizarro_cape",
  "lights": "sl:shade_sun_1",
  "supercharging": "sl:superchargedlights1.tx.json",
  "null": "sl:null",
  "suittexture": "sl:superman_suit_texture",
  "ksickness": "sl:kryptonite_sickness",
  "xk_eyes": "sl:x_kryptonite_abuse_lights",
  "drug_abuse": "sl:drug_abuse"
});
...
function init(renderer, trailType) {
  ...
  renderer.setItemIcons("%s_0", "%s_1", "%s_2", "superman_3");
...
kutils.nightVision(renderer);
    ...
    boobas.setExtrude(1.10).setYOffset(1);
...
physics.setTickHandler(entity => {
  ...
  f = 1 - f * f * f;
  var restAngle = entity.getData("fiskheroes:flying") ? f* 1.5 : b * 24; // Conditionally set restAngle
  ...
  tired_cape = capes.createDefault(
    renderer,
    24,
    "fiskheroes:cape_default.mesh.json",
    physics
  );
  tired_cape.effect.texture.set("cape_tired");
  tired_cape.effect.width = 14;
...
//supercharged
  ...
  utils.bindBeam(renderer, "fiskheroes:energy_projection", "sl:breath", "head", 0xFFFFFF, [
    { "firstPerson": [0.0, 1.0, 0.0], "offset": [0.0, -1.2, -4.0], "size": [1.2, 0.7] }
  ]).setParticles(renderer.createResource("PARTICLE_EMITTER", "sl:snow_impact_1")).setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:gravity_amount") > 0 && entity.getData("fiskheroes:gravity_amount") <= 0.25);

  utils.bindBeam(renderer, "fiskheroes:energy_projection", "sl:breath_1", "head", 0x8F9194, [
    { "firstPerson": [0.0, 1.0, 0.0], "offset": [0.0, -1.2, -4.0], "size": [1.2, 0.7] }
  ]).setParticles(renderer.createResource("PARTICLE_EMITTER", "sl:super_breath_impact_3")).setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:gravity_amount") > 0.25 && entity.getData("fiskheroes:gravity_amount") <= 0.5);
  ...
  utils.bindBeam(renderer, "fiskheroes:energy_projection", "sl:breath", "head", 0xADD8E6, [
    { "firstPerson": [0.0, 1.0, 0.0], "offset": [0.0, -1.2, -4.0], "size": [1.2, 0.7] }
  ]).setParticles(renderer.createResource("PARTICLE_EMITTER", "sl:snow_impact_2")).setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:gravity_amount") <= 0 && entity.getData("fiskheroes:gravity_amount") >= -0.75);
...
// superman
utils.bindTrail(renderer, "sl:kryptoniantrail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman');
...
utils.bindTrail(renderer, "sl:superchargedkryptoniantrail").setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman_supercharged');

// superman s1
utils.bindTrail(renderer, "sl:kryptoniantrail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman/s1');

utils.bindTrail(renderer, "sl:superchargedkryptoniantrail").setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman_supercharged/s1');

// black superman
utils.bindTrail(renderer, "sl:talrhotrail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman/black2');

utils.bindTrail(renderer, "sl:superchargedtalrhotrail").setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman_supercharged/black2');

// og superman
utils.bindTrail(renderer, "sl:ogsupermantrail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman/ogsuperman');

utils.bindTrail(renderer, "sl:superchargedogsupermantrail").setCondition(entity => entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.getEquipmentInSlot(3).nbt().getString('HeroType') === 'sl:superman_supercharged/ogsuperman');
...
// TRAILS
  ...
  utils.bindBeam(renderer, "fiskheroes:charged_beam", "sl:solar_blast", "head", 0xFF1200, [
...
function updateIntensity() {
  ...
  xkeyes = renderer.createEffect("fiskheroes:overlay");
  xkeyes.texture.set(null, "xk_eyes");
  ...
  utils.bindParticles(renderer, "sl:landing_smoke").setCondition(entity => entity.getInterpolatedData('fiskheroes:dyn/superhero_landing_ticks') > 10 && entity.getInterpolatedData('fiskheroes:dyn/superhero_landing_ticks') < 14);
   ...
   utils.bindParticles(renderer, "sl:transform_smoke").setCondition(entity => entity.getData("sl:dyn/suitup_timer") < 1 && entity.getData("sl:dyn/suitup_timer") > 0 && entity.getEquipmentInSlot(3).nbt().getString('HeroType') !== 'sl:superman/black2');
...
function render(entity, renderLayer, isFirstPersonArm) {
    if (entity.getEquipmentInSlot(1).nbt().getBoolean("isgay") && !entity.getData("sl:dyn/absorb")) {
    boobas.render();
    }
  ...
  if (renderLayer === "CHESTPLATE" || renderLayer === "LEGGINGS" || renderLayer === "HELMET" || renderLayer === "BOOTS") {
    ...
    supercharged.opacity = entity.getInterpolatedData("sl:dyn/absorb") / 2;
    supercharged.render();
    } else {
...
if (renderLayer === "CHESTPLATE" && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).damage() <= 500) {
    cape.render(entity);
} else if (renderLayer === "CHESTPLATE" && !entity.getData("sl:dyn/suitup") && entity.getEquipmentInSlot(3).damage() > 500 && entity.getEquipmentInSlot(3).damage() <= 850) {
    tired_cape.render(entity);
}
