...
var shakehv = renderer.bindProperty("fiskheroes:camera_shake").setCondition(entity => {
    ...
    utils.bindBeam(renderer, "fiskheroes:charged_beam", beam, "head", "0x66FF47", [
    ...
    ]).setParticles(renderer.createResource("PARTICLE_EMITTER", "sl:kryptonite_beam_impact"));
    ...
    beam2 = utils.createLines(renderer, ("BEAM_RENDERER", "sl:kryptonite_gauntlet_beam"), 0x66FF47, [
        {"start": [0.0, 1.0, 0.0], "end": [0.0, 1.5, 0.0 ], "size": [12.0, 4.0]},
    ]);
    beam2.setOffset(-1.25, 8.5, 0.0)
