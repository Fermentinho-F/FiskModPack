...
loadTextures({
  "layer1": "sl:supergirl_dceu_layer1",
  "layer2": "sl:supergirl_dceu_layer1",
  "eyes": "sl:eyes",
...
function initEffects(renderer) {
  ...
  utils.bindTrail(renderer, "sl:kryptoniantrail").setCondition(entity => !entity.getData("sl:dyn/absorb") && entity.getData("fiskheroes:speeding") && entity.isSprinting() && !entity.getData("sl:dyn/suitup"));
