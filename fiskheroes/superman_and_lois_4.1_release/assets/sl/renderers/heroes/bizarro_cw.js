...
loadTextures({
  "layer1": "sl:supergirl/bizarro_cw_layer1_hair",
  "layer2": "sl:supergirl/bizarro_cw_layer2",
  "eyes": "sl:heat_vision_cw_eyes",
  "cape": "sl:supergirl/bizarro_cw_cape",
  "cape_hair": "sl:supergirl/bizarro_cw_cape_hair",
  "lights": "sl:supercharged",
  "supercharging": "sl:sun",
  "null": "sl:null",
  "suittexture": "sl:superman_suit_texture",
  "chest": "sl:supergirl/bizarro_cw_layer1",
  "hair": "sl:supergirl/bizarro_cw_hair",
...
function initAnimations(renderer) {
  ...
  addAnimation(renderer, "bizarro.POSE", "sl:bizarro_pose").setData((entity, data) => data.load(1 - entity.getData("fiskheroes:flight_timer")))
  .priority = -10;
...
if (renderLayer === "CHESTPLATE") {
  ...
  if (entity.getEquipmentInSlot(4).nbt().getString('HeroType') === 'sl:bizarro_cw') {
    cape2.render(entity);
  } else {
    cape.render(entity);
  }
