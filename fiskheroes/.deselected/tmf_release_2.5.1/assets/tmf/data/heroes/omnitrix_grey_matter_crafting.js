...
function init(hero) {
    ...
    hero.addPrimaryEquipment("fiskheroes:holographic_display_stand", false);
    hero.addPrimaryEquipment("fiskheroes:eternium_block", false);
    hero.addPrimaryEquipment("minecraft:repeater", false);
    hero.addPrimaryEquipment("fiskheroes:dwarf_star_alloy", false);
