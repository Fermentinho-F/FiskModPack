...
function init(hero) {
    ...
    hero.setVersion("Comics-New 52/Isue 40-52");
    hero.setTier(7);
    ...
    hero.addPowers("tmhp:speed_force", "tmhp:forwarding_time");
    ...
    hero.addKeyBind("FORWARD", "Move Time Forward", 3);
    ...
    hero.addAttributeProfile("FORWARD", forwardProfile);
...
function isKeyBindEnabled(entity, keyBind) {
    switch (keyBind) {
    case "FORWARD":
        return entity.getData('fiskheroes:speed') > 5 && !entity.getData('fiskheroes:punchmode');
    case "CHARGED_PUNCH":
        return entity.getData("fiskheroes:speeding") && !entity.getData('fiskheroes:dyn/steeled');
    case "CHARGE_ENERGY":
