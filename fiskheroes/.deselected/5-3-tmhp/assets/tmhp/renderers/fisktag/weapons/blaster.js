...
function init(renderer) {
    model = utils.createModel(renderer, "tmhp:blaster", "base");
    ...
    utils.bindScopedBeam(renderer, "fiskheroes:repulsor_blast", teams.teamBasedColor(0x1122FF), [
        { "firstPerson": [3.0, 3.5, 2.0], "offset": [10.0, -5.0, 2.0], "size": [0.8, 0.8] }
    ], [10.0, -5.0, 2.0]);
}
