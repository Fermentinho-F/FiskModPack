extend("tmhp:nightwing");
loadTextures({
    "layer1": "tmhp:dc/batfamily/nightwing/tmsd/layer1",
    "layer2": "tmhp:dc/batfamily/nightwing/default/layer2",
    "electric_glow": "tmhp:dc/batfamily/nightwing/tmsd/electric_glow",
...
function initEffects(renderer) {
    ...
    utils.bindTrail(renderer, "tmhp:electrical_suit_gold").setCondition(entity => entity.getData("tmhp:dyn/electrical_timer") > 0);
    renderer.bindProperty("fiskheroes:equipment_wheel").color.set(0xFFFF11);
