extend("loriatpack:batman");
loadTextures({
    "layer1": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_justice_lords_layer1",
    "layer2": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_justice_lords_layer2",
    "cape": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_justice_lords_cape",
	"cape2": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_justice_lords_cape_2",
	"ears": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_ears_jl",
	"spikes": "loriatpack:justice_legaue/batmans/batman_justice_lords/batman_justice_lords_spike"
});
...
function initEffects(renderer) {
    ...
    spikes.setModel(utils.createModel(renderer, "loriatpack:batman_justice_lords_spike", "spikes"));
    spikes.anchor.set("leftArm");
	spikes.setOffset(5.0, -2.0, 0.0);
	
	spikes2 = renderer.createEffect("fiskheroes:model");
    spikes2.setModel(utils.createModel(renderer, "loriatpack:batman_justice_lords_spike", "spikes"));
    spikes2.anchor.set("rightArm");
	spikes2.setOffset(10.5, 12.5, 5.5);
