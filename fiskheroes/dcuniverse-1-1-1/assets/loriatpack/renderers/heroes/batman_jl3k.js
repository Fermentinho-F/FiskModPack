...
loadTextures({
    "layer1": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_layer1",
    "layer2": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_layer2",
	"lights": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_eyes",
    "cape": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_cape",
	"cape2": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_cape_2",
	"spikes": "loriatpack:justice_legaue/batmans/batman_jl3k/batman_jl3k_spikes"
});
...
function initEffects(renderer) {
    ...
    spikes.setModel(utils.createModel(renderer, "loriatpack:batman_jl3k_spike", "spikes"));
    spikes.anchor.set("leftArm");
	spikes.setOffset(5.0, -2.0, 0.0);
	
	spikes2 = renderer.createEffect("fiskheroes:model");
    spikes2.setModel(utils.createModel(renderer, "loriatpack:batman_jl3k_spike", "spikes"));
    spikes2.anchor.set("rightArm");
	spikes2.setOffset(10.5, 12.0, 5.5);
